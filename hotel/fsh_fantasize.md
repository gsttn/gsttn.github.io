...
グラン棟と比較してしまえばリーズナブルな部屋という扱いになりそうですが、ファンタジースプリングスホテルの宿泊特典を活用することは可能なので、開業から当面は争奪戦は継続しそうです。
ほとぼりが冷めた後でも、グラン棟との価格差や全体的な価格次第ではそれなりに争奪戦は激しくなりそうです。
とは言え、部屋の位置を考える余地があるとすれば、特に争奪戦が激しそうなのはスプリングスサイドくらいでしょうか。
