...
* 案：抽選
    ...
    * そもそも、抽選は**誰にとってもが行きたい日に取れる確率が最も低くなる仕組み**、どうせ行けるか否かに関わりなく予約界隈ではひたすら抽選に応募する未来にしかならない
* 案：年会費で優遇
...
* 案：キャンセル拾い
    ...
    * 人間の時間を莫大な単純作業に奪われるし、機械的な監視が圧倒的になり得る
...
[元ネタツイート](https://twitter.com/GsttnTwt/status/1607250456585334786?s=20) 参照


### バケパ争奪戦が地獄になる理由

バケーション・パッケージ、いわゆるバケパですが、基本的に1ヶ月分とかが一括開放されますので、原則としてアクセス集中が毎回発生するような状況になりますね。
単に開放自国にアクセス集中が起きるという訳ではなく、少し早めの時間からページに入ろうとする人が出てくるのは、パレード初日に朝から地蔵する民と同様、Dヲタの習性なのでしょうかね。
...
どのURLが良いとか、経路が良いみたいな調査はしたことがないので何とも言えまいところですが、レア部屋を除けばある程度は掴めるのではないかと思います。
...
このように途中まで進めた予約枠もエラーとなれば、放置枠として後で再び開放されることになります。
...
AIであるBingChetとミラコスタの話をしていたときに、投げかけた質問への答えがなかなかの人格者でした。
