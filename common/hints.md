...
公式に謳われているものではないですが、X（Twitter）のTDR予約界隈で語られている非公式でありながら、多くの方が知っている情報をまとめます。
...
例えば、宿泊予約なら『閑散期の真冬』『宿泊対象が平日』『予約開放日も平日』『メンテナンス等でショーが休止中』くらいまで悪条件が重なって、やっと少し難易度が下がるかも知れない程度です。
...
* キャンセル枠を一般向けに公開するタイミングに関しては日程も時刻も公式からの情報公開はない
    * X（Twitter）等で『この時間帯に公開されやすい』といった情報があっても、それはあくまでも記載した方の個人的な感想や結果論でしかない
...
ということで、実際に行ける確率とレア枠の確保に関して[X（Twitter）アカウントで実施したアンケートの結果と考察](https://x.com/GsttnTwt/status/1517755369426018304)を参考までに再掲しておきます。

----

* アンケート設問： どうしても行きたいと思っているハバグラやハバテラ宿泊予約、レストランならハイピやドリマの空き枠を見つけた際、その空き枠の日程で『どの程度行けそう』なら確保しますか？
* 回答結果（全115票）
...
特にX（Twitter）の予約界隈では、こういった人々が不要な枠の『お譲り』や、自分が欲しい別の枠との『交換』を呼びかけるケースがあります。
