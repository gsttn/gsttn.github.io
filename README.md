...
* グラン棟の予約に成功してラリベ予約を取れないと本当に不安ですよね…
    * どこかにも書きましたが、ラリベの時間帯と席の数から試算するとグラン棟の全部屋分くらいの枠は取れそうな気がするのですよね
    * もし取れないとすると、それは朝食2日分とか夕食2日分を確保（ルール的には可能）した宿泊者が多いパターンくらいではないかと思うのですよね、これだと最大で部屋数の2倍の枠が必要になりますので…
    * 仮に現状で公開されている枠が少ないということであれば、例のアンケートの自由記入欄で相談してみるという手もあるかも知れませんね
    * というか、この程度のことは事前に公式側で予想していて然るべきなので、アンケートとご相談で希望を聞いて調整する方針ではないか、と予想……というか、このような方針であろうと信じたいところです（苦笑
